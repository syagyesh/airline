...
public class main_program {
    ...
    public static void main(String[] args) {
        ...
        try (Scanner o_num = new Scanner(System.in)) {
                        ...
                        case 2 -> {
                            ...
                            while (true) {
                                ...
                                if (apd == 0) {
                                    ...
                                    try (Scanner sc_ap = new Scanner(System.in)) {
                                        switch (apd) {
                                            case 1 -> {
                                                //add record
                                                ap[arp] = new airport();
                                            ...
                                            case 3 -> {
                                                ...
                                                for (com.airline.airport airport : ap) {
                                                    if (ap[0] == null) {
                                                        System.out.println("...No Data Present in Record...");
                                                        break;
                                                    }
                        ...
                        case 3 -> {
                            ...
                            while (true) {
                                ...
                                if (fd == 0) {
                                    ...
                                    try (Scanner sc_f = new Scanner(System.in)) {
                                        switch (fd) {
                                            case 1 -> {
                                                //add record
                                                f[fr] = new flight();
                        ...
                        case 4 -> {
                            ...
                            while (true) {
                                ...
                                if (cfd == 0) {
                                    ...
                                    try (Scanner sc_cf = new Scanner(System.in)) {
                                        switch (cfd) {
                                            case 1 -> {
                                                //add record
                        ...
                        case 5 -> {
                            ...
                            while (true) {
                                ...
                                if (ed == 0) {
                                    ...
                                    try (Scanner sc_e = new Scanner(System.in)) {
                                        switch (ed) {
                                            case 1 -> {
                                                //add record
                                                e[er] = new employee();
                        ...
                        case 6 -> {
                            ...
                            while (true) {
                                ...
                                if (pd == 0) {
                                    ...
                                    try (Scanner sc_p = new Scanner(System.in)) {
                                        switch (pd) {
                                            case 1 -> {
                                                //add record
                                                p[pr] = new passenger();
                        ...
                        case 7 -> {
                            ...
                            while (true) {
                                ...
                                if (bkd == 0) {
                                    ...
                                    try (Scanner sc_bk = new Scanner(System.in)) {
                                        switch (bkd) {
                                            case 1 -> {
                                                //add record
                                                bk[brk] = new booking();
                        ...
                        case 8 -> {
                            ...
                            while (true) {
                                ...
                                if (ccd == 0) {
                                    ...
                                    try (Scanner sc_cc = new Scanner(System.in)) {
                                        switch (ccd) {
                                            case 1 -> {
                                                //add record
                        ...
                        case 9 -> {
                            ...
                            while (true) {
                                ...
                                if (td == 0) {
                                    ...
                                    try (Scanner sc_t = new Scanner(System.in)) {
                                        switch (td) {
                                            case 1 -> {
                                                //add record
                                                t[tr] = new ticket();
